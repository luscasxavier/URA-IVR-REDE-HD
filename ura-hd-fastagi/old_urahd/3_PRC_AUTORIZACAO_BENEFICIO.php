...
function M1_1_3_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY, $cnpjcpfValidado){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);

    //65
    $indice++;
    tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO', 'PROTOCOLO', $protocoloEASY);
    ...
    M1_1_3_autorizacao_beneficio_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY,$cnpjcpfValidado);    
}

function M1_1_3_autorizacao_beneficio_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY,$cnpjcpfValidado){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($opcao > $qntdade){
        if(retentar_dado_invalido("AUTORIZACAO BENEFICIO CNPJ","uraHD/5","OPCAO INVALIDA"))M1_1_3_autorizacao_beneficio_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado);
        else{
        ...
        if(retentar_dado_invalido("AUTORIZACAO BENEFICIO CNPJ","uraHD/5","CLIENTE NAO DIGITOU OPCAO"))M1_1_3_autorizacao_beneficio_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado);
        else{
        ...
        inicializa_ambiente_novo_menu();
        validar_senha_estabelecimento($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato);
    }
}

function validar_senha_estabelecimento($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato){ 
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if (preg_match("/^(\d{5})$/",$senha_estabelecimento)){
        ...
        if($validasenha){
            ...
            inicializa_ambiente_novo_menu();
            submenu_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento);

        }else{
            //74
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO', 'RETORNO', 'SENHA INVALIDA');
            if(retentar_dado_invalido("validar_senha_estabelecimento","uraHD/22","SENHA ERRADA"))validar_senha_estabelecimento($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato);
            else{
                //76
                $indice++;
        ...
        if(retentar_dado_invalido("validar_senha_estabelecimento","uraHD/5","TIMEOUT"))validar_senha_estabelecimento($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato);
        else{
            //76
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO', 'PERCURSO', 'TENTATIVAS EXCEDIDAS SENHA INVALIDA');
...
function  submenu_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case 1:
            ...
            $retorno='avista';
            autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$retorno);
            break;
        case 2:
            inicializa_ambiente_novo_menu();
        ...
        case 3:
            inicializa_ambiente_novo_menu();
            estorno_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento);
            break;
        
        default:
            if(retentar_dado_invalido("OPCOES","uraHD/5","OPCAO INVALIDA"))submenu_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento);
            else{
                //79
                $indice++;
                tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO', 'PERCURSO', 'TENTATIVAS EXCEDIDAS SENHA INVALIDA');
...
function autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$retorno){ 
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(preg_match("/^(\d{17})$/",$numero_cartao)){
        ...
        if($validacartao){
            ...
            switch ($retorno) {
                case 'avista':
                    inicializa_ambiente_novo_menu();                    
                    segue_vendasavista($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao);
                    break;
                case 'parcelado':
                    inicializa_ambiente_novo_menu();
                    segue_parcelado($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao);
                    break;
                default:
            ...
            if(retentar_dado_invalido("autorizacao_beneficio","uraHD/32","numero do cartao invalido"))autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$retorno);
            else{
                //106
                $indice++;
        ...
        if(retentar_dado_invalido("autorizacao_beneficio","uraHD/5","numero do cartao digitado errado ou n digitado"))autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$retorno);
...
function segue_vendasavista($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(strlen($valor_total_venda) > 2 && $valor_total_venda > 100){
        ...
        if($opcao == 5){
            ...
            inicializa_ambiente_novo_menu();
            segue_autoriza_transacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,'N','1',$tipotransacao);
            
        }else{
            if(retentar_dado_invalido("segue_vendasavista","uraHD/5",""))segue_vendasavista($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao);
        ...
        if(retentar_dado_invalido("segue_vendasavista","uraHD/34","menor que 1 real"))segue_vendasavista($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao);
        else{
            //110
            $indice++;
...
function segue_parcelado($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$etapa = '1',$valor_total_venda ='1'){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(strlen($valor_total_venda) > 2 && $valor_total_venda > 100){
        ...
        switch ($opcao) {
            case '2':
                $vendacomentrada = 'S';
                inicializa_ambiente_novo_menu();
                segue_parcelado_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$vendacomentrada,$valor_total_venda);
                break;
            ...
            default:
                if(retentar_dado_invalido("segue_parcelado","uraHD/5","OPCAO NAO SELECIONADA")){segue_parcelado($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,2,$valor_total_venda);
        ...
        if(retentar_dado_invalido("segue_parcelado","uraHD/34","menor que 1 real"))segue_parcelado($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao);
        else{
            //110
            $indice++;
...
function segue_parcelado_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$vendacomentrada,$valor_total_venda){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($parcelas == 'TIMEOUT'){
        ...
        if(retentar_dado_invalido("segue_parcelado_2","uraHD/5","NAO DIGITOU QUANTIDADE DE PARCELAS"))segue_parcelado_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$vendacomentrada,$valor_total_venda);
        else{
            //113.2
            $indice++;
        ...
        inicializa_ambiente_novo_menu();
        segue_parcelado_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$vendacomentrada,$valor_total_venda,$parcelas);
    }    
}

function segue_parcelado_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$vendacomentrada,$valor_total_venda,$parcelas){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        case 'TIMEOUT':
            inicializa_ambiente_novo_menu();
            segue_autoriza_transacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao);
        break;

        default:
            if(retentar_dado_invalido("segue_parcelado_3","uraHD/5","NAO DIGITOU OPCAO VALIDA"))segue_parcelado_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$tipotransacao,$vendacomentrada,$valor_total_venda,$parcelas);
            else{
...
function segue_autoriza_transacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(preg_match("/^(\d{5})$/",$senha_atual)){
        ...
        if($validasenha){
            ...
            if($autorizatransacao->{"autorizada"} =='S'){
                ...
                inicializa_ambiente_novo_menu();
                segue_finalizacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao);
            }else{
                //121
                $indice++;
            ...
            if(retentar_dado_invalido("segue_autoriza_transacao","uraHD/22","SENHA ERRADA"))segue_autoriza_transacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao);
            else{
                //120
                $indice++;
        ...
        if(retentar_dado_invalido("segue_autoriza_transacao","uraHD/5","nao digitou senha"))segue_autoriza_transacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao);
        else{
            //120
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO – PARCELADA/A VISTA', 'PERCURSO', 'TENTATIVAS EXCEDIDAS SENHA INVALIDA');
...
function segue_finalizacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao,$etapa='1'){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case '1':
            ...
            segue_finalizacao_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao);
        break;
        ...
        default:
            if(retentar_dado_invalido("OPCOES","uraHD/5","OPCAO INVALIDA"))segue_finalizacao($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao,2);
            else{
...
function segue_finalizacao_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao){
        ...
        case "TIMEOUT":
            if(retentar_dado_invalido("OPCOES","uraHD/5","TIMEOUT"))segue_finalizacao_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao);
            else{
                //129
                $indice++;
        ...
        default:
            if(retentar_dado_invalido("OPCOES","uraHD/5","OPCAO INVALIDA"))segue_finalizacao_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$numero_cartao,$valor_total_venda,$vendacomentrada,$parcelas,$tipotransacao,$valor_total_venda_formatado,$autorizatransacao);
            else{
                //129
                $indice++;
                tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO – PARCELADA', 'PERCURSO', 'TENTATIVAS EXCEDIDAS (9 – NOVA TRANSACAO OU DESLIGUE O TELEFONE)');
...
function estorno_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case '1':
            $tipotransacao='A';
            inicializa_ambiente_novo_menu();
            estorno_autorizacao_beneficio_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao);
        break;
        ...
        default:
            if(retentar_dado_invalido("estorno_autorizacao_beneficio","uraHD/5","TIMEOUT"))estorno_autorizacao_beneficio($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento);
            else{
                //132
                $indice++;
...
function estorno_autorizacao_beneficio_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$etapa = '1',$numero_cartao = '1'){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(preg_match("/^(\d{17})$/",$numero_cartao)){
        ...
        if($validacartao){
            ...
            if(strlen($valor_total_venda) > 2 && $valor_total_venda > 100){
                ...
                inicializa_ambiente_novo_menu();
                estorno_autorizacao_beneficio_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao);

            }else{
                if(retentar_dado_invalido("estorno_autorizacao_beneficio","uraHD/5","TIMEOUT"))estorno_autorizacao_beneficio_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,2,$numero_cartao);
                else{
                    //136
                    $indice++;
            ...
            if(retentar_dado_invalido("estorno_autorizacao_beneficio","uraHD/33","TIMEOUT"))estorno_autorizacao_beneficio_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao);
            else{
                //136
                $indice++;
                tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO – ESTORNO', 'PERCURSO', 'TENTATIVAS EXCEDIDAS CARTAO INVALIDO');
        ...
        if(retentar_dado_invalido("estorno_autorizacao_beneficio","uraHD/5","TIMEOUT"))estorno_autorizacao_beneficio_2($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao);
        else{
            //136
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO – ESTORNO', 'PERCURSO', 'TENTATIVAS EXCEDIDAS CARTAO INVALIDO');
...
function estorno_autorizacao_beneficio_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(preg_match("/^(\d{5})$/",$cod_autoriza)){
        ...
        if($validaautorizacao->{'transacaoLocalizada'}=='S'){
            ...
            inicializa_ambiente_novo_menu();
            estorno_autorizacao_beneficio_4($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao,$validaautorizacao,$cod_autoriza,$valor_total_venda_formatado);
            ...
            if(retentar_dado_invalido("estorno_autorizacao_beneficio_3","uraHD/46","DIGITOU NUMERO DA AUTORIZACAO ERRADO"))estorno_autorizacao_beneficio_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao);
            else{
                //142
                $indice++;
        ...
        if(retentar_dado_invalido("estorno_autorizacao_beneficio_3","uraHD/5","DIGITOU NUMERO DA AUTORIZACAO ERRADO"))estorno_autorizacao_beneficio_3($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao);
        else{
            //142
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO – ESTORNO', 'PERCURSO', 'TENTATIVAS EXCEDIDAS AUTORIZACAO INVALIDA');
...
function estorno_autorizacao_beneficio_4($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao,$validaautorizacao,$cod_autoriza,$valor_total_venda_formatado){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(preg_match("/^(\d{5})$/",$senha_atual)){
        ...
        if($validasenha){
            ...
            switch ($opcao) {
                ...
                case 'TIMEOUT':
                    ...
                    if($estorno->{'descricaoRetorno'} == 'Estorno efetuado com sucesso!'){
                        ...
                        inicializa_ambiente_novo_menu();
                        estorno_autorizacao_beneficio_5($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao);
                ...
                default:
                    ...
                    if(retentar_dado_invalido("estorno_autorizacao_beneficio_4","uraHD/5","DIGITOU OPCAO INVALIDA"))estorno_autorizacao_beneficio_4($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao,$validaautorizacao,$cod_autoriza);
                    else{
                        //146
                        $indice++;
            ...
            if(retentar_dado_invalido("estorno_autorizacao_beneficio_4","uraHD/22","DIGITOU SENHA ERRADA OU INVALIDA"))estorno_autorizacao_beneficio_4($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao,$validaautorizacao,$cod_autoriza);
            else{
                //146
                $indice++;
        ...
        if(retentar_dado_invalido("estorno_autorizacao_beneficio_4","uraHD/5","DIGITOU SENHA ERRADA OU INVALIDA"))estorno_autorizacao_beneficio_4($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao,$valor_total_venda,$numero_cartao,$validaautorizacao,$cod_autoriza);
        else{
            //146
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO BENEFICIO – ESTORNO', 'PERCURSO', 'TENTATIVAS EXCEDIDAS SENHA INVALIDA');
...
function estorno_autorizacao_beneficio_5($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("estorno_autorizacao_beneficio_4","uraHD/5","DIGITOU SENHA ERRADA OU INVALIDA"))estorno_autorizacao_beneficio_5($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$contrato,$senha_estabelecimento,$tipotransacao);
            else{
                //152
                $indice++;
