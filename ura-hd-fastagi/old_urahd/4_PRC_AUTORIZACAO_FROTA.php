...
function M1_1_4_autorizacao_frota_pt1($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado){
    ...
    M1_1_4_autorizacao_frota_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado);    
}

function M1_1_4_autorizacao_frota_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($opcao > $qntdade){
        if(retentar_dado_invalido("AUTORIZACAO FROTA CNPJ","uraHD/5","OPCAO INVALIDA"))M1_1_4_autorizacao_frota_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado);
        else{
        ...
        if(retentar_dado_invalido("AUTORIZACAO FROTA CNPJ","uraHD/5","CLIENTE NAO DIGITOU OPCAO"))M1_1_4_autorizacao_frota_pt2($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado);
        else{
        ...
        inicializa_ambiente_novo_menu();
        M1_1_4_1_recebiveis_senha($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato);
    }
}

function M1_1_4_1_recebiveis_senha($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(preg_match("/^(\d{5})$/",$senha_estabelecimento)){
        ...
        if($validasenha){
            ...
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_cartao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento);
            ...
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS SENHA","uraHD/22","SENHA NAO VALIDADA PELA API"))M1_1_4_1_recebiveis_senha($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato);
            else{
                //172
                $indice++;
        ...
        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS SENHA","uraHD/5","SENHA NAO DIGITADA CORRETAMENTE"))M1_1_4_1_recebiveis_senha($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato);
        else{
            //172
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'PERCURSO', 'TENTATIVAS EXCEDIDAS SENHA INVALIDA');
...
function M1_1_4_1_recebiveis_cartao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if (preg_match("/^(\d{17})$/",$numero_cartao)){
        ...
        if($valida_cartao->{'CartaoValido'}=='S'){
            ...
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_frota($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao);
        }else{
            //175
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'RETORNO', 'CARTAO INVALIDO');

            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS CARTAO","uraHD/32","API NAO VALIDOU O CARTAO"))M1_1_4_1_recebiveis_cartao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento);
        ...
        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS CARTAO","uraHD/32","USUARIO NAO DIGITOU NENHUM DADO"))M1_1_4_1_recebiveis_cartao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento);
        else{
            //176
            $indice++;
        ...
        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS CARTAO","uraHD/32","CARTAO NAO DIGITADO CORRETAMENTE"))M1_1_4_1_recebiveis_cartao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento);
        else{
            //176
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'PERCURSO', 'TENTATIVAS EXCEDIDAS CARTAO INVALIDO');
...
function M1_1_4_1_recebiveis_frota($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($opcao =='2'){
        ...
        inicializa_ambiente_novo_menu();
        M1_1_4_1_recebiveis_km($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao);
    }else{
        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS FROTA","uraHD/5","CARTAO NAO DIGITADO CORRETAMENTE"))M1_1_4_1_recebiveis_frota($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao);
        else{
            //180
            $indice++;
...
function M1_1_4_1_recebiveis_km($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($km >= 1){
        ...
        inicializa_ambiente_novo_menu();
        M1_1_4_1_recebiveis_matricula($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km);
    }else{
        //183
        $indice++;
        tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'RETORNO', 'KILOMETRAGEM INVALIDA');

        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS QUILOMETRAGEM","uraHD/5","KILOMETRAGEM DIGITADA INCORRETAMENTE"))M1_1_4_1_recebiveis_km($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao);
        else{
            //184
            $indice++;
...
function M1_1_4_1_recebiveis_matricula($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if (strlen($matricula)<=20){
        ...
        if($vld_mtcl->{'MatriculaValida'}=='S'){
            ...
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_confirma_matricula($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            ...
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS MATRICULA","uraHD/5","MATRICULA NAO LOCALIZADA"))M1_1_4_1_recebiveis_matricula($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km);
            else{
                //188
                $indice++;
                tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'RETORNO', 'MATRICULA INVALIDA');
...
function M1_1_4_1_recebiveis_confirma_matricula($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case '1':
            ...
            M1_1_4_1_recebiveis_produto($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS CONFIRMA MATRICULA","uraHD/5","MATRICULA INCORRETA"))M1_1_4_1_recebiveis_confirma_matricula($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
                //192
                $indice++;
                tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'PERCURSO', 'TENTATIVAS EXCEDIDAS (1 – SIM OU 2 – NAO)');
...
function M1_1_4_1_recebiveis_produto($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case '1':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_combustivel($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;

        case '2':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_acessorios($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;

        case '3':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_borracharia($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
            
        case '4':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_filtros($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
            
        case '5':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_limpeza($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;    

        case '6':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_lubrificacao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
        
        case '7':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_oleos($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
        
        case '8':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_manutencao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;

        case '9':
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_portaria($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
        
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS PRODUTOS","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
                //195
                $indice++;
    ...
    inicializa_ambiente_novo_menu();
    M1_1_4_1_recebiveis_qntd_produto($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto);
}

function M1_1_4_1_recebiveis_qntd_produto($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if(strlen($qntd_produto)>=2 && $qntd_produto != 'TIMEOUT'){
        ...
        inicializa_ambiente_novo_menu();
        M1_1_4_1_recebiveis_produto_valor($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto, $qntd_produto);
    }else{
        //198
        $indice++;
        tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'RETORNO', 'QUANTIDADE NAO INFORMADA');

        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS QUANTIDADE DE PRODUTOS","uraHD/5","QUANTIDADE INCORRETA"))M1_1_4_1_recebiveis_qntd_produto($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto);
        else{
            //199
            $indice++;
...
function M1_1_4_1_recebiveis_produto_valor($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto, $qntd_produto){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($valor_prod>=100){
        ...
        inicializa_ambiente_novo_menu();
        M1_1_4_1_recebiveis_confirma_venda($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto, $qntd_produto, $valor_prod);
    }else{
        //202
        $indice++;
        tracking($canal, $ddr, $ticket, $indice, 'AUTORIZACAO FROTA', 'RETORNO', 'VALOR PREENCHIDO INCORRETAMENTE');

        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS VALOR DE PRODUTOS","uraHD/5","VALOR INVALIDO"))M1_1_4_1_recebiveis_produto_valor($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto, $qntd_produto);
        else{
            //203
            $indice++;
...
function M1_1_4_1_recebiveis_confirma_venda($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto, $qntd_produto, $valor_prod){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case '1':            
            ...
            if($autoriza_svc_vnd_frt->{'autorizada'}=='S'){
                ...
                inicializa_ambiente_novo_menu();
                M1_1_4_1_recebiveis_finaliza($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt, $senhaMt);
            }else{
                //207
                $indice++;
                ...
                inicializa_ambiente_novo_menu();
                M1_1_4_1_recebiveis_erro_api($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt, $senhaMt);        
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS CONFIRMA VENDA","uraHD/5","VALOR INVALIDO"))M1_1_4_1_recebiveis_confirma_venda($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $cod_produto, $qntd_produto, $valor_prod);
            else{
                //206
                $indice++;
...
function M1_1_4_1_recebiveis_erro_api($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ERRO API","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_erro_api($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt);
            else{
                //216
                $indice++;
...
function M1_1_4_1_recebiveis_finaliza($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    inicializa_ambiente_novo_menu();
    M1_1_4_1_recebiveis_encerra($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt);
}

function M1_1_4_1_recebiveis_encerra($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    if($opcao =='9'){
        ...
        inicializa_ambiente_novo_menu();
        M1_1_4_autorizacao_frota_pt1($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $cnpjcpfValidado);

    }else{
        if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ENCERRA","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_encerra($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula, $valor_prod, $cod_produto, $qntd_produto, $autoriza_svc_vnd_frt);
        else{
            //211
            $indice++;
...
function M1_1_4_1_recebiveis_produto_combustivel($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        case '1':
            verbose("ETANOL");
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_combustivel_etanol($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;

        case '2':
            verbose("DIESEL");
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_combustivel_diesel($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;

        case '3':
            verbose("GASOLINA");
            inicializa_ambiente_novo_menu();
            M1_1_4_1_recebiveis_produto_combustivel_gasolina($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            break;
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_combustivel($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_combustivel_etanol($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ETANOL","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_combustivel_etanol($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_combustivel_diesel($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS DIESEL","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_combustivel_diesel($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_combustivel_gasolina($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS GASOLINA","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_combustivel_gasolina($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_acessorios($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ACESSORIOS","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_acessorios($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_borracharia($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS BORRACHARIA","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_borracharia($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_filtros($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO FILTROS","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_filtros($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_limpeza($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO LIMPEZA","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_limpeza($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_lubrificacao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO LUBRIFICACAO","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_lubrificacao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_oleos($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO LIMPEZA","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_oleos($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
                //encerra_por_retentativas("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO LIMPEZA","uraHD/26","OPCAO INVALIDA");
                encerra_com_tracking($canal, $ddr, $ticket, $indice, "ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO LIMPEZA","uraHD/26","OPCAO INVALIDA");
            }
...
function M1_1_4_1_recebiveis_produto_manutencao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO MANUTENCAO","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_manutencao($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
...
function M1_1_4_1_recebiveis_produto_portaria($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    tracking_canal_ativo($canal, $ddr, $ticket, $indice);
    ...
    switch ($opcao) {
        ...
        default:
            if(retentar_dado_invalido("ANTECIPACAO DE RECEBIVEIS ESCOLHA DE PRODUTO PORTARIA","uraHD/5","OPCAO INVALIDA"))M1_1_4_1_recebiveis_produto_portaria($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $contrato, $senha_estabelecimento, $numero_cartao, $valida_cartao, $km, $matricula);
            else{
