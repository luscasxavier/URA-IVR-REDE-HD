...
function Op01_1_2_alterar_senha_de_ec($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY, $cnpjcpfValidado){
    ...
    if ($opcao == 1){
        ...
        Op01_1_2_alterar_senha_de_ec_opc1($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY, $cnpjcpfValidado);
        ...
        if($validarhorario){
            ...
            //dial_fast("gw02-kontac33/210");
            dial_return("gw02-kontac33/210");
        ...
        if(retentar_dado_invalido("Op01_1_2_alterar_senha_de_ec","uraHD/5","OPCAO INVALIDA"))Op01_1_2_alterar_senha_de_ec($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY);
        else{
            //45
            $indice++;
...
function Op01_1_2_alterar_senha_de_ec_opc1($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY, $cnpjcpfValidado){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    //46
    $indice++;
    ...
    if(preg_match("/^(\d{5})$/",$senha)){
        ...
        if($validar_senha){
            ...
            inicializa_ambiente_novo_menu();
            Op01_1_2_alterar_senha_de_ec_senha_validada($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY,$senha, $cnpjcpfValidado);
            ...
            if(retentar_dado_invalido("Op01_1_2_alterar_senha_de_ec_opc1","uraHD/22","senha incorreta"))Op01_1_2_alterar_senha_de_ec_opc1($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY);
            else{
                //48
                $indice++;
        ...
        if(retentar_dado_invalido("Op01_1_2_alterar_senha_de_ec_opc1","uraHD/5","nao digitou a senha"))Op01_1_2_alterar_senha_de_ec_opc1($uniqueid ,$origem ,$cnpjcpf ,$protocoloEASY);
        else{
            //48
            $indice++;
            tracking($canal, $ddr, $ticket, $indice, 'ALTERAR SENHA DE EC', 'PERCURSO', 'TENTATIVAS EXCEDIDAS SENHA INVALIDA');
...
function Op01_1_2_alterar_senha_de_ec_senha_validada($uniqueid, $origem, $cnpjcpf, $protocoloEASY, $senha, $cnpjcpfValidado){
    global $canal, $ddr, $ticket, $indice, $horaAtual;
    //50
    $indice++;
